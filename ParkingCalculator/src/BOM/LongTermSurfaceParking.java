...
public class LongTermSurfaceParking extends BaseClass{
	//test with empty entry date & leave date
		@Test (priority = 1)
		public void ChooseaParkingLot01 () {
			new Select(BaseClass.getWebdriver().findElement(By.id("ParkingLot"))).selectByVisibleText("Long-Term Surface Parking");
